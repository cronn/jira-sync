...
public final class IssueTypeMapper {

	private static final Logger log = LoggerFactory.getLogger(IssueTypeMapper.class);

	private IssueTypeMapper() {
	}

	public static JiraIssueType mapIssueType(JiraIssue sourceIssue, JiraSyncConfig syncConfig, JiraProjectSync projectSync, JiraProject targetProject) {
